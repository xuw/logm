...
public class MSR_DistinctValueCount extends Configured implements Tool {
  
	private static Logger LOG = LogFormatter.getLogger(MSR_DistinctValueCount.class);
...
public static class MapClass extends MapReduceBase
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new MSR_DistinctValueCount(), args);
    System.exit(res);
  }
